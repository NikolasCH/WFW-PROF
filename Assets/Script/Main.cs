...
public class Main : MonoBehaviour {
	...
	public static int AdsRevard = 200;
	
	public static int w_o=100;
...
// проверяем сложилли пользователь слово
		for(int j=0; j<letters.Length; j++)
		{
			if(ws[t]==null && t==letters[j].ToString().ToUpper() && game){
				...
				CoinAdd(100+100*PlayerPrefs.GetInt("page"));
	...
	public static void onArchiments(){
		...
		if (PlayerPrefs.GetInt("Star") >= 25 && !PlayerPrefs.HasKey ("achievement_100")) {
			PlayerPrefs.SetInt ("achievement_100", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQAQ");
		} 
		
		 if (PlayerPrefs.GetInt("Star") >= 50 && !PlayerPrefs.HasKey ("achievement_200")) {
			PlayerPrefs.SetInt ("achievement_200", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQAg");
		} 
		
		 if (PlayerPrefs.GetInt("Star") >= 100 && !PlayerPrefs.HasKey ("achievement_300")) {
			PlayerPrefs.SetInt ("achievement_300", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQAw");
		} 
		
		 if (PlayerPrefs.GetInt("Star") >= 125 && !PlayerPrefs.HasKey ("achievement_400")) {
			PlayerPrefs.SetInt ("achievement_400", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQBA");
		} 
		
		 if (PlayerPrefs.GetInt("Star") >= 150 && !PlayerPrefs.HasKey ("achievement_500")) {
			PlayerPrefs.SetInt ("achievement_500", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQBQ");
		} 
		
		 if (PlayerPrefs.GetInt("Star") >= 180 && !PlayerPrefs.HasKey ("achievement_600")) {
			PlayerPrefs.SetInt ("achievement_600", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQBw");
		} 

		if (PlayerPrefs.GetInt("Coin") >= 1000 && !PlayerPrefs.HasKey ("coin_1000")) {
			PlayerPrefs.SetInt ("coin_1000", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQCA");
		} else if (PlayerPrefs.GetInt("Coin") >= 2000 && !PlayerPrefs.HasKey ("coin_2000")) {
			PlayerPrefs.SetInt ("coin_2000", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQCQ");
		} else if (PlayerPrefs.GetInt("Coin") >= 3000 && !PlayerPrefs.HasKey ("coin_3000")) {
			PlayerPrefs.SetInt ("coin_3000", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQCg");
		}else if (PlayerPrefs.GetInt("Coin") >= 4000 && !PlayerPrefs.HasKey ("coin_4000")) {
			PlayerPrefs.SetInt ("coin_4000", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQCw");
		} else if (PlayerPrefs.GetInt("Coin") >= 5000 && !PlayerPrefs.HasKey ("coin_5000")) {
			PlayerPrefs.SetInt ("coin_5000", 1);
			GameCenter.unlockAchievement ("CgkIh4yMlfcCEAIQDA");
		} 
	}
	...
	public static void Cost_Word () {	
		...
		for(int f=0; f<letters.Length; f++)
		{
			...
			if(ws[t]==null){
				if(w_o==0)w_o=100+(100*PlayerPrefs.GetInt("page"));
			}
		}
